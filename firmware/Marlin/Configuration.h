...
#define CUSTOM_MENDEL_NAME "XL300"
...
#define HOMING_FEEDRATE {70*60, 70*60, 15*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,160,308}  // default steps per unit for Ultimaker
